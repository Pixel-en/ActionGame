...
void RankingsSystem::Draw()
{
	/*if (cLogo->GetOutput()) {*/
		...
		DrawBoxAA(435, 390, 440, 440, GetColor(255, 255, 255), TRUE);//入力バー
		...
		//	int n = y2 + space;
		//	if(i > 0)
		//	  DrawBoxAA(n, y1, x2 + word, y2, GetColor(255, 255, 255), TRUE); //した棒
		//	else
		//	  DrawBoxAA(x1, y1, x2, y2 , GetColor(255, 255, 255), TRUE); //した棒
		//}

		DrawBoxAA(519, 440, 542, 445, GetColor(255, 255, 255), TRUE); //した棒
		DrawBoxAA(486, 440, 511, 445, GetColor(255, 255, 255), TRUE); //した棒
		DrawBoxAA(x1,y1,x2,y2, GetColor(255, 255, 255), TRUE); //した棒
